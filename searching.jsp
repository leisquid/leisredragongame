    ...
    <body>
        ...
        <div align="center">
            <table width="1200" border="0" class="lookupTable">
                <tr><td colspan="10"><h2>查询模式</h2></td></tr>
                <tr>
                    <td colspan="10">
                        <form action="searching.jsp" method="post">
                            ...
                            <select name="searchMethod">
                                ...
                                <option value="reading"
                                        <%
                                            if(searchMethod.equals("reading")) {
                                                out.print(" selected=\"selected\" ");
                                            }
                                        %>
                                />查名称
                                <option value="readingId"
                                        <%
                                            if(searchMethod.equals("readingId")) {
                                                out.print(" selected=\"selected\" ");
                                            }
                                        %>
                                />查 ID
                                <option value="panelId"
                                        <%
                                            if(searchMethod.equals("panelId")) {
                                                out.print(" selected=\"selected\" ");
                                            }
                                        %>
                                />查图片 ID
                                <option value="headSymbol"
                                        <%
                                            if(searchMethod.equals("headSymbol")) {
                                                out.print(" selected=\"selected\" ");
                                            }
                                        %>
                                />查首字韵母
                                <option value="tailSymbol"
                                        <%
                                            if(searchMethod.equals("tailSymbol")) {
                                                out.print(" selected=\"selected\" ");
                                            }
                                        %>
                                />查尾字韵母
                ...
                <tr>
                    <td colspan="10">
                        为了方便搜索，查找韵母时请用“v”代替“ü”。或者<a href="listAll.jsp">点我查看所有词条</a>？
                    </td>
                </tr>
                ...
                <%
                    while (textCounter < words.getTotal()) {
                        ...
                        do {
                            ...
                            out.println("<a href=\"showInfo.jsp?infoMode=1&search=" + words.getReadingIdByIndex(picCounter) + "\">");
                        ...
                        do {
                            textCounter ++;
                            out.println("<td align=\"center\">");
                            out.print("<a href=\"showInfo.jsp?infoMode=1&search=" + words.getReadingIdByIndex(textCounter)
                                    +"\" class=");
